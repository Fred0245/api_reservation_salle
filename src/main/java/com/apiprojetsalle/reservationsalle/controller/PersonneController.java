...
public class PersonneController {
    ...
    @RequestMapping(value = "/personne/authentifier", method = RequestMethod.POST, headers = "accept=Application/json")
    public Personne authentifier(@RequestBody DonneesLogin donneesLogin) {
    	Personne personne = new Personne();

        try {
        	personne = this.personneService.authentifier(donneesLogin);
        } catch (Exception e) {
